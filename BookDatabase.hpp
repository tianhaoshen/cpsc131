...
class BookDatabase {
 public:
  ...
  Book* find(const std::string& isbn);  // Returns a pointer to the item in the
                                        // database if found, nullptr otherwise
  // Queries
 ...
 private:
  ...
  BookDatabase(const BookDatabase&) =
      delete;  // intentionally prohibit making copies
  BookDatabase& operator=(const BookDatabase&) =
      delete;  // intentionally prohibit copy assignments

  ///////////////////////// TO-DO (2) //////////////////////////////
  /// Private implementation details
  std::vector<Book> datalist;
  /////////////////////// END-TO-DO (2) ////////////////////////////
};
